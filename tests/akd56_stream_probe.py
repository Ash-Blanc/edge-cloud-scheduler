...
def main():
    ...
    shapes = [
        ...
        (5, official5(seed=711, R=100, lout=96, pproc=165, span=15.0,
                      bw=14.0, lat=5.0),
         "CANON k-shrink-identical R100 L96 pp165 bw14"),
        (6, official6(seed=812, R=150, lout=36, pproc=160, span=4.0,
                      bw=11.0, lat=4.4),
         "CANON k-shrink-identical R150 L36 pp160 bw11"),
        (5, official5(seed=711, R=100, lout=96, pproc=160, span=15.0),
         "old fitted5 bw8 pp160 (also IDENTICAL, looser)"),
